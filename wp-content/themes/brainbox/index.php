					...
					<div class="container-xl">
							<div class="row mt-5 border-bottom border-cinza2">
									<div class="col-6 col-md-8">
										<?php if( $categories ) { ?>
											<ul>
													<li><a href="<?php echo get_permalink( get_option( 'page_for_posts' ) ); ?>" class="ativo">Todos</a></li>
									...
									<div class="col-6 col-md-4">
										<form action="<?php echo site_url(); ?>" class="d-flex justify-content-end flex-grow-1" method="get">
                        <input id="blog-faixa-filtro-input-search" type="text" name="s" value="" /><!-- class="d-inline-block" -->
